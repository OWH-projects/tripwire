...
import re
import datetime
from tripwire.models import PottWarrant
from django.core.management.base import BaseCommand, CommandError


class Command(BaseCommand):
    args = 'None'
    help = "Scrape pott county warrants, which is actually pretty swell."
    ...
    def handle(self, *args, **options):
        ...
        for row in table.findAll('tr')[1:]:
            ...
            PottWarrant.objects.create(last=last, first=first, date_conf=date_conf, time_conf=time_conf, age=age, height=height, weight=weight, sex=sex, race=race, charges=charges, bond=bond)        
